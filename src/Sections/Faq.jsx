...
const Faq = () => {
    return (
        <div>
            <section class="py-10 lg:m-28 rounded-3xl bg-[#F2F8FE] sm:py-16 lg:py-24">
                <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div class=" mx-auto text-center">
                        <p class="text-lg lg:text-4xl  font-semibold tracking-widest text-black ">Expert Consulting Services</p>

                        <h2 class="mt-6 text-sm font-normal leading-tight text-black sm:text-4xl lg:text-base">Phasellus vulputate porttitor libero, lipsum rhoncus lipsum accumsan diam vulputate <br /> porttitor ullamcorper sollicitudin porttitor vitae.s</h2>
                    </div>
                    ...
                    <div class="grid items-center grid-cols-1 mt-12 gap-y-10 lg:grid-cols-5 sm:mt-20 gap-x-4">
                        ...
                        <div class="lg:col-span-3">
                            <img class="w-full rounded-lg " src={faq} alt="" />
                        </div>
                    </div>
                </div>
            </section>
