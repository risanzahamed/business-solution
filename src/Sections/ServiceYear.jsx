                    ...
                    <div class="flex flex-col lg:flex-row lg:items-stretch lg:min-h-[800px]">
                        <div class="relative flex items-center justify-center w-full lg:order-2 lg:w-7/12">
                            ...
                            <div class="relative px-4 pt-24 pb-16 text-center sm:px-6 md:px-24 2xl:px-32 lg:py-24 lg:text-left">
                                <h1 class="text-4xl font-medium leading-tight text-gray-900 sm:text-5xl sm:leading-tight lg:leading-tight lg:text-5xl">
                                ...
                                <div class="grid grid-cols-1 gap-8 mt-10 text-left lg:mt-24 sm:gap-x-8 md:grid-cols-3">
                                    <div>
                                        <h3 class="font-bold text-5xl">
                                            <span class="text-transparent bg-clip-text bg-[#fb5850]">
                                                18
                                                + </span>
                                        </h3>
                                        <p class="mt-4 text-xl font-medium text-gray-900">Global country</p>

                                    </div>

                                    <div>
                                        <h3 class="font-bold text-5xl">
                                            <span class="text-transparent bg-clip-text bg-[#fb5850]"> 25M</span>
                                        </h3>
                                        <p class="mt-4 text-xl font-medium text-gray-900">Happy client</p>

                                    </div>

                                    <div>
                                        <h3 class="font-bold text-5xl">
                                            <span class="text-transparent bg-clip-text bg-[#fb5850]"> 289 </span>
                                        </h3>
                                        <p class="mt-4 text-xl font-medium text-gray-900">Success projects</p>
