...
const About = () => {
    return (
        <div>
            <section class="pt-10 bg-[#F7F5E6] sm:pt-16 lg:pt-24">
                <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    <div class="max-w-2xl mx-auto text-center">
                        <h2 class="text-4xl font-medium leading-tight text-gray-900 sm:text-5xl sm:leading-tight lg:leading-tight lg:text-5xl">Real humans are here to help you building your brand</h2>
